...
export default function About(){
  ...
  return (
    <React.Fragment>
      ...
      >
        <Grid item>
        <Typography align='center' variant='h2' className={classes.aboutMeBody}>About Me</Typography>
        <Typography variant='h6' align=
        'center'>I’ve worked for companies ranging from small/independent, medium/franchise, to large corporations and can adapt to any type of working environment. I have a well rounded knowledge of frontend languages/backend frameworks and have deployed an [array] of projects to showcase this fluency. I have also collaborated with other software developers on projects and have the ability to learn new languages and concepts.
  <br /><br />
